 ...
 */
    ...
    (() => {
        ...
        const script_open = document.querySelector(".actions-top__icon_open");
        script_open.addEventListener("click", (function(e) {
            script_open.classList.toggle("_active");
            list.classList.toggle("_active");
        }));
        const like = document.querySelector(".actions-bottom__like");
        like.addEventListener("click", (function(e) {
            like.classList.toggle("_active");
        }));
        const dislike = document.querySelector(".actions-bottom__dislike");
        dislike.addEventListener("click", (function(e) {
            dislike.classList.toggle("_active");
        }));
        const save = document.querySelector(".actions-bottom__save");
        save.addEventListener("click", (function(e) {
            save.classList.toggle("_active");
        }));
        const share = document.querySelector(".actions-bottom__share");
        share.addEventListener("click", (function(e) {
            share.classList.toggle("_active");
        }));
        const script_button = document.querySelector(".top-item__button");
        script_button.innerHTML;
        script_button.addEventListener("click", (function(e) {
            script_button.classList.toggle("_active");
        }));
        window["FLS"] = true;
        isWebp();
        menuInit();
